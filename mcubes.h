...
using namespace std;
const static int edgeTable [256][13] = {
...
void readFile(vector<vector<vector<float>>>& vec_val, ifstream& inp, int p, int r, int c);
void processVector(vector<vector<vector<float>>> &vec_val, vector<coord>& vec_vertex,vector<coord>& vec_nor, float threshold,int p, int r, int c);
